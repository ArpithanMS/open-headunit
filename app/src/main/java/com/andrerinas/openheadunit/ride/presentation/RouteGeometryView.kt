 ...
 * tiles, no network dependency. This is deliberately the whole "route on a map" feature for now:
 * it needs no new library and carries none of the minSdk/dependency risk a real tile-backed map
 * would (see the MapLibre investigation) - a real map is a later, separate addition, not a
 * blocker for seeing the shape of a recorded ride today.
 *
